...
class TestDownloadFilingsBatch:
    ...
    def test_fmt_passed_to_download_filing(self, tmp_path):
        ...
        # fmt='pdf' makes download_filings_batch open a shared Playwright browser.
        # Patch it out: launching real Chromium here is slow enough to trip the
        # 30 s suite timeout on a cold cache, and this test is about argument
        # forwarding, not browser startup.
